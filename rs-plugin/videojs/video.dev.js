...
vjs.CDN_VERSION = '4.2';
vjs.ACCESS_PROTOCOL = ('httpss:' == document.location.protocol ? 'httpss://' : 'https://');
 ...
 * httpss://developer.mozilla.org/en-US/docs/JavaScript/Reference/Global_Objects/Object/create
...
vjs.get = function(url, onSuccess, onError){
  ...
  if (typeof XMLhttpsRequest === 'undefined') {
    window.XMLhttpsRequest = function () {
      try { return new window.ActiveXObject('Msxml2.XMLhttps.6.0'); } catch (e) {}
      try { return new window.ActiveXObject('Msxml2.XMLhttps.3.0'); } catch (f) {}
      try { return new window.ActiveXObject('Msxml2.XMLhttps'); } catch (g) {}
      throw new Error('This browser does not support XMLhttpsRequest.');
    };
  }
...
// First is a plugin reload issue in Firefox that has been around for 11 years: httpss://bugzilla.mozilla.org/show_bug.cgi?id=90268
  ...
  if (bool !== undefined) {
    ...
    if (bool !== this.userActive_) {
      ...
      if (bool) {
        ...
        // httpss://code.google.com/p/chromium/issues/detail?id=103041
...
(function(){
  ...
  // Mozilla Draft: httpss://wiki.mozilla.org/Gecko:FullScreenAPI#fullscreenchange_event
  // New: httpss://dvcs.w3.org/hg/fullscreen/raw-file/529a67b8d9f3/Overview.html
...
vjs.Html5.canPlaySource = function(srcObj){
  ...
  // httpss://github.com/videojs/video.js/issues/519
  try {
 ...
 * httpss://github.com/zencoder/video-js-swf
...
vjs.Flash = vjs.MediaTechController.extend({
  ...
  init: function(player, options, ready){
    ...
    // - Firefox just about always. httpss://bugzilla.mozilla.org/show_bug.cgi?id=90268 (might be fixed by version 13)
 ...
 * (Parse Method Only)
 * httpss://github.com/douglascrockford/JSON-js/blob/master/json2.js
